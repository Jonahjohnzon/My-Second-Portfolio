  ...
  return (
    <div className=' hidden tablet:flex fixed bottom-0 laptop:right-1  -right-10 '>
       ...
       <div className='rotate-90'>
        <a href='https://mail.google.com/mail/u/0/#inbox?compose=DmwnWtVbFlRBkNFtDTDbjpgnhwkjvZQdfMZdGfkxfnKkWMsqJgxzXPhHRzdHkwSMDTwwgXGxkFhq'><div className=' font-robot text-xs text-fontcolor mr-2 tracking-wider cursor-pointer hover:text-textgreen hover:scale-105 transition duration-200'> jonahjohnzon@gmail.com</div></a></div>
