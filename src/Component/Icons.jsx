...
const Icons = () => {
  ...
  return (
    ...
    <a href='https://www.instagram.com/luzeboxez/'><FiInstagram  className='mb-5 cursor-pointer text-fontnude hover:text-textgreen text-lg hover:scale-125 transition duration-200'/></a>
